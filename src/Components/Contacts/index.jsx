          ...
          <ul className='grid grid-cols-2 gap-[30px] my-4'>
            <li className='flex gap-[20px] w-[300px]'>
              ...
              <div className='text-left'>
                ...
                <p className='text-[14px] my-[14px] text-[#a1a1a1]'>{t("contact.address2")}</p>
              </div>
            </li>
            <li className='flex gap-[20px] w-[300px]'>
              ...
              <div className='text-left'>
                ...
                <a className='text-[14px] my-[14px] text-[#a1a1a1]' href="tel:+998935138833">+998 (33) 258 73 58</a>
              </div>
            </li>
            <li className='flex gap-[20px] w-[300px]'>
              ...
              <div className='text-left'>
                ...
                <p className='text-[14px] my-[14px] text-[#a1a1a1]'>{t("contact.hours2")}</p>
              </div>
            </li>
            <li className='flex gap-[20px] w-[300px]'>
