    ...
    <section>
      <div className='py-5'>
        <div className='max-w-[1200px] mx-auto'>
          <p className='text-[40px] text-center font-bold mb-[30px] mx-[66px]'>Why us? Why most people choose us?</p>
          <p className='mb-[70px] text-[40px] text-center font-bold ' style={{color: "rgb(108, 45, 186)"}}>Our Benefits</p>
